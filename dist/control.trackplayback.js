...
const TrackPlayBackControl = external_root_L_commonjs_leaflet_commonjs2_leaflet_amd_leaflet_default.a.Control.extend({
  ...
  _createCheckbox: function (labelName, className, container, fn) {
    const divEle = external_root_L_commonjs_leaflet_commonjs2_leaflet_amd_leaflet_default.a.DomUtil.create(
      "div",
  ...
  _createSlider: function (className, container, fn) {
    ...
    external_root_L_commonjs_leaflet_commonjs2_leaflet_amd_leaflet_default.a.DomEvent.on(
      sliderEle,
      "click mousedown dbclick",
      external_root_L_commonjs_leaflet_commonjs2_leaflet_amd_leaflet_default.a.DomEvent.stopPropagation
    )
